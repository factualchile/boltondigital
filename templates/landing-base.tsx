...
export default function LandingBase({
  ...
  imageUrl = "https://images.unsplash.com/photo-1559839734-2b71f1536783?q=80&w=400&h=400&auto=format&fit=crop",
  slogan = "Comprometido con el bienestar de las parejas en Chile.",
    ...
    <div className="landing-container" style={{ 
          ...
          <div className="col-center" style={{ 
            ...
            <div className="specialties-box" style={{ 
                ...
                <div className="specialties-grid" style={{ 
                    display: "grid", 
                    gridTemplateColumns: specialties.length > 5 ? "1fr 1fr" : "1fr", 
                    gap: "0.7rem 2.5rem" 
                }}>
          ...
          <div className="col-right" style={{ 
            ...
            <motion.button 
              ...
              style={{
                ...
                justifyContent: "center",
                gap: "0.6rem",
                marginTop: !includeGuarantee ? "auto" : "0"
              }}
            >
              RESERVAR
              <ArrowRight size={18} />
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
          ...
          .header { padding: 0.5rem 5% !important; flex-direction: column; text-align: center; gap: 0.2rem !important; }

...
export default function ClientLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Simple check: All levels can access the user dashboard,
            // but we redirect them specifically to the freelance-wordpress dashboard
        ...
        <main style={{
            ...
            <div className="glass" style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <h1 style={{ fontSize: '2rem', marginTop: '1.5rem' }}>Acceso <span className="text-gradient">Clientes</span></h1>
                    <p style={{ color: 'var(--fg-muted)', marginTop: '0.5rem' }}>Ingresa a tu cuenta de soporte</p>
                </div>
                ...
                <p style={{ textAlign: 'center', marginTop: '2rem', color: 'var(--fg-muted)', fontSize: '0.9rem' }}>
                    ¿Necesitas una cuenta? <Link href="/register" style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>Contrata un servicio aquí</Link>
                </p>
            </div>
        </main>
    );

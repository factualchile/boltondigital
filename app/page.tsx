      ...
      {!showAuth ? (
        ...
        >
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem", justifyContent: "center", marginBottom: "3rem" }}>
            <button className="btn btn-primary" style={{ padding: "1.2rem 2.8rem", fontSize: "1rem" }} onClick={() => setShowAuth(true)}>
              Comenzar gratis <ArrowRight size={18} />
            </button>
            <button className="btn btn-secondary" style={{ padding: "1.2rem 2.8rem", fontSize: "1rem" }}>
              Saber más
            </button>
          </div>
